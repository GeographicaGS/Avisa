 ...
 */
Mapea.Format.WMC.v1 = OpenLayers.Class(OpenLayers.Format.WMC.v1, {
    ...
    read_ol_displayInLayerSwitcher: function(layerInfo, node) {
        ...
        if (!Mapea.Util.isNullOrEmpty(nodeValue)) {
            nodeValue = nodeValue.toLowerCase();
            nodeValue = OpenLayers.String.trim(nodeValue);
        }
    ...
    CLASS_NAME: "Mapea.Format.WMC.v1" 
