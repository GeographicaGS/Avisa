 ...
 *  - <OpenLayers.Tile>
 */
Mapea.Tile.Image = OpenLayers.Class(OpenLayers.Tile.Image, {
    ...
    /*initialize: function(layer, position, bounds, url, size, options) {
        ...
        // MODIFICACIÓN SALVADOR Y HUGO //
        //Se comenta el if para que aparezcan los div con las imágenes
   ...
   /* getImage: function() {
        if (!this.imgDiv) {
            ...
            if (this.frame) {
                ...
                // MODIFICACIÓN SALVADOR Y HUGO //
                //Las imágenes no necesitan left y top
//                style.left = -left + "%";
//                style.top = -top + "%";
...
//            }
            // MODIFICACIÓN SALVADOR Y HUGO //
            //El position de las imágenes es relative
    ...
    /*setImgSrc: function(url) {
        var img = this.imgDiv;
        // MODIFICACIÓN SALVADOR Y HUGO //
        //Las imágenes no tienen ni visibility ni opacity
    ...
    /*onImageLoad: function() {
        ...
        // MODIFICACIÓN SALVADOR Y HUGO //
        //La imágenes no tienen visibility ni opacity
