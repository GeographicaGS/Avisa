 ...
 *     <Mapea.Tile> constructor, or a subclass. 
 * 
 * TBD 3.0 - remove reference to url in above paragraph
 * 
 */
Mapea.Tile = OpenLayers.Class({
     ...
     * 
     * Constructor: Mapea.Tile
     * Constructor for a new <Mapea.Tile> instance.
     * 
     * Parameters:
     ...
     *
     * Parameters:
     * obj - {<Mapea.Tile>} The tile to be cloned
     *
     * Returns:
     * {<Mapea.Tile>} An exact clone of this <Mapea.Tile>
     */
    clone: function (obj) {
        if (obj == null) {
            obj = new Mapea.Tile(this.layer, 
                                      this.position, 
                                      this.bounds, 
                                      this.url, 
                                      this.size);
